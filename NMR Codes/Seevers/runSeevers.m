...
if isempty(m) && isempty(n)
    ...
    for i = 1:length(siteList)
        ...
        [K,z,T2dist,T2logbins,k_boot,k_mcmc,k_direct,bestFitMatrix,b_boot,totalErrorEstimate] = computeSeevers(siteName,[],[],figureson,wDirect);
    ...
    for j = 1:length(m)
        ...
        for i = 1:length(siteList)
            ...
            [K,z,T2dist,T2logbins,k_boot,k_mcmc,k_direct,bestFitMatrix,b_boot,totalErrorEstimate] = computeSeevers(siteName,n(j),m(j),figureson,wDirect);
