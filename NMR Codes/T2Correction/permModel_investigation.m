...
scatter((T2SeeversAll_Maurer_vec(worstPoints_Maurer_Seevers_Ind)).^2,Kall_Maurer_vec(worstPoints_Maurer_Seevers_Ind),60,'filled','k')
...
legend('Wisconsin Data','Kansas + Washington Data','Wisc Seevers Model (n=2,m=0)','K+W Seevers Model (n=2,m=0)','K Difference Factor > 10')
