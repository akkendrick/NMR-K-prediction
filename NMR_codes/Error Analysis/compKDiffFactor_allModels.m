% Plot K diff factor for different models
...
for kk = 1:length(sites)
    ...
    SDR_diffFactor{kk} = estimateKdiffFactor(K,SDR_Kest{kk},1);
    Seevers_diffFactor{kk} = estimateKdiffFactor(K,Seevers_Kest{kk},1);
    SOE_diffFactor{kk} = estimateKdiffFactor(K,SOE_Kest{kk},1);
    KGM_diffFactor{kk} = estimateKdiffFactor(K,KGM_Kest{kk},1);
