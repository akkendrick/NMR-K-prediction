function [T2dist,T2logbins,SEdecayTime,SEdecayUniform,SEdecay,oneDVectors,...
    ...
    if sum(strcmp(siteName,kanWash_sites) == 1)
        ...
        rawBaseDir = 'I:\My Drive\USGS Project\Kansas_Wash_Data\';
    ...
    elseif sum(strcmp(siteName,wisc_sites) == 1)
       ...
       in3 = [rawBaseDir site '/' name '/' name '_SE_decay_time' '.txt'];
       in4 = [rawBaseDir site '/' name '/' name '_SE_decay_uniform' '.txt'];
       in5 = [rawBaseDir site '/' name '/' name '_SE_decay' '.txt'];
       in6 = [rawBaseDir site '/' name '/' name '_1Dvectors' '.txt'];
       in7 = [rawBaseDir site '/' name '/' name '_1Dvectors_uniform' '.txt'];
