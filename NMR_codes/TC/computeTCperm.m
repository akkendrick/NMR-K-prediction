function [K,z,T2dist,T2logbins,kTC_best,bestFitMatrix,MAEError,errorFactor,indexQuotient] = computeTCperm(baseName,n,m,cutoff,figureson)
...
MAEError = computeError(K,kTC_best);
errorFactor = mean(estimateKdiffFactor(K,kTC_best,1));
