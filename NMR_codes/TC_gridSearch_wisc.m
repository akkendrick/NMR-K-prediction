...
save('optimalCutoffTable_n1_mvar.mat','totalmMatrix','totalnMatrix','totalcMatrix','totalErrorMatrix','cutoff','siteList','n','m')
...
g6aSmooth = smooth(totalErrorMatrix(1,:),smoothWindow);
g5aSmooth = smooth(totalErrorMatrix(3,:),smoothWindow);
g6bSmooth = smooth(totalErrorMatrix(2,:),smoothWindow);
g5bSmooth = smooth(totalErrorMatrix(4,:),smoothWindow);
pn1Smooth = smooth(totalErrorMatrix(5,:),smoothWindow);
pn2Smooth = smooth(totalErrorMatrix(6,:),smoothWindow); 
g6Smooth = smooth(totalErrorMatrix(7,:),smoothWindow);
g5Smooth = smooth(totalErrorMatrix(8,:),smoothWindow);
